function [] = saveVelocityFieldsReproductionNoScat(file,X,Y,D,d,f_vec,doa_vec,decoding_method,speaker_dirs,source_distance,indexes,max_distance,delay,N_speakers,encoding_regularization)
