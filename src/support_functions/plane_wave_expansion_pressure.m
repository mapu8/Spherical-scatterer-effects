function [p_cmplx] = plane_wave_expansion_pressure(t,f,m0,phi0,doa,X,Y,N,D,indexes)
%PLANE_WAVE_EXPANSION_PRESSURE Compute the pressure field with plane wave
%                              expansion.
...
% phi0 - initial phase
% doa - direction of arrival [azimuth elev] in radians
