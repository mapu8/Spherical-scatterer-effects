function [p_cmplx, position_vectors] = point_sources_pressure(t,frequencies,source_positions,magnitudes,initial_phases,X,Y,N,D,indexes)
%POINT_SOURCES_PRESSURE Compute the pressure field created by a number of point
%                       sources.
