...
delay_distance=0.02
outputfile="saved_outputs/non_diffuse_tdesign_first_order2_noscat_delay_"$delay_distance"_$SLURM_ARRAY_TASK_ID.mat"
N_diffuse_repetitions=20
setting="tdesign_first_order_noscat_delay"
