...
outputfile="saved_outputs/non_diffuse_dtu_dtumic3D_encoding_radinv_noscat_allrad_5thorder_$SLURM_ARRAY_TASK_ID.mat"
N_diffuse_repetitions=20
setting="dtu_eigenmike_encoding_noscat"
encoding_regularization="radinv_dtu"
