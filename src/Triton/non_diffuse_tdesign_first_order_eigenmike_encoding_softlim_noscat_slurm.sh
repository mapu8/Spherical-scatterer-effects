...
outputfile="saved_outputs/non_diffuse_tdesign_first_order_eigenmike_encoding2_softlim_noscat_$SLURM_ARRAY_TASK_ID.mat"
N_diffuse_repetitions=20
setting="tdesign_first_order_eigenmike_encoding_noscat"
